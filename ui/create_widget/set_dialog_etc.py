...
class SetDialogEtc:
    ...
    def set(self):
        ...
        self.ui.hg_pushButtonnn_01 = self.wc.setPushbutton('이전(Alt+left)', parent=self.ui.dialog_hoga, bounced=True, click=lambda: hg_button_clicked_01(self.ui, '이전'), shortcut='Alt+left')
        self.ui.hg_pushButtonnn_02 = self.wc.setPushbutton('다음(Alt+right)', parent=self.ui.dialog_hoga, bounced=True, click=lambda: hg_button_clicked_01(self.ui, '다음'), shortcut='Alt+right')
        self.ui.hg_pushButtonnn_03 = self.wc.setPushbutton('매수(Alt+up)', parent=self.ui.dialog_hoga, color=2, bounced=True, click=lambda: hg_button_clicked_02(self.ui, '매수'), shortcut='Alt+up')
        self.ui.hg_pushButtonnn_04 = self.wc.setPushbutton('매도(Alt+down)', parent=self.ui.dialog_hoga, color=3, bounced=True, click=lambda: hg_button_clicked_02(self.ui, '매도'), shortcut='Alt+down')
        ...
        self.ui.db_pushButtonnn_18 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_01(self.ui))
        ...
        self.ui.db_pushButtonnn_01 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_02(self.ui))
        ...
        self.ui.db_pushButtonnn_02 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_03(self.ui))
        ...
        self.ui.db_pushButtonnn_03 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_04(self.ui))
        ...
        self.ui.db_pushButtonnn_04 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_05(self.ui))
        ...
        self.ui.db_pushButtonnn_05 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_06(self.ui))
        ...
        self.ui.db_pushButtonnn_06 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_07(self.ui))
        self.ui.db_labellllllll_07 = QLabel('백테DB에 당일DB의 데이터 추가하기 (추가 후 당일DB는 삭제됨)', self.ui.db_groupBoxxxxx_01)
        self.ui.db_pushButtonnn_07 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_08(self.ui))
        self.ui.db_labellllllll_08 = QLabel('당일DB를 일자DB로 분리하기', self.ui.db_groupBoxxxxx_01)
        self.ui.db_pushButtonnn_08 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_09(self.ui))
        self.ui.db_labellllllll_09 = QLabel('거래기록 테이블 모두 삭제 (체결목록, 잔고목록, 거래목록, 일별실현손익)', self.ui.db_groupBoxxxxx_01)
        self.ui.db_pushButtonnn_09 = self.wc.setPushbutton('실행', parent=self.ui.db_groupBoxxxxx_01, bounced=True, click=lambda: dbbutton_clicked_10(self.ui))
        ...
        self.ui.od_pushButtonnn_01 = self.wc.setPushbutton('매수', parent=self.ui.od_groupBoxxxxx_01, color=2, bounced=True, click=lambda: odbutton_clicked_01(self.ui))
        self.ui.od_pushButtonnn_02 = self.wc.setPushbutton('매도', parent=self.ui.od_groupBoxxxxx_01, color=3, bounced=True, click=lambda: odbutton_clicked_02(self.ui))
        self.ui.od_pushButtonnn_03 = self.wc.setPushbutton('BUY_LONG', parent=self.ui.od_groupBoxxxxx_01, color=2, bounced=True, click=lambda: odbutton_clicked_03(self.ui))
        self.ui.od_pushButtonnn_04 = self.wc.setPushbutton('SELL_LONG', parent=self.ui.od_groupBoxxxxx_01, color=3, bounced=True, click=lambda: odbutton_clicked_04(self.ui))
        self.ui.od_pushButtonnn_05 = self.wc.setPushbutton('SELL_SHORT', parent=self.ui.od_groupBoxxxxx_01, color=2, bounced=True, click=lambda: odbutton_clicked_05(self.ui))
        self.ui.od_pushButtonnn_06 = self.wc.setPushbutton('BUY_SHORT', parent=self.ui.od_groupBoxxxxx_01, color=3, bounced=True, click=lambda: odbutton_clicked_06(self.ui))
        self.ui.od_pushButtonnn_07 = self.wc.setPushbutton('매수취소', parent=self.ui.od_groupBoxxxxx_01, bounced=True, click=lambda: odbutton_clicked_07(self.ui))
        self.ui.od_pushButtonnn_08 = self.wc.setPushbutton('매도취소', parent=self.ui.od_groupBoxxxxx_01, bounced=True, click=lambda: odbutton_clicked_08(self.ui))
        ...
        self.ui.vsp_pushButton_02 = self.wc.setPushbutton('저장하기', parent=self.ui.dialog_pattern, bounced=True, click=lambda: spike_setting_save(self.ui))
        self.ui.vsp_pushButton_03 = self.wc.setPushbutton('학습하기', parent=self.ui.dialog_pattern, color=4, bounced=True, click=lambda: spike_train(self.ui))

        self.ui.vpf_labellllll_01 = QLabel('  ▣ 가격대분석  |  분석시간(초/분)                     등락율(%)                     가격분할(%)', self.ui.dialog_pattern)
        self.ui.vpf_comboBoxxx_01 = self.wc.setCombobox(self.ui.dialog_pattern, hover=False, items=['5', '10', '15', '20', '30', '60', '300'])
        ...
        self.ui.vpf_pushButton_00 = self.wc.setPushbutton('도움말', parent=self.ui.dialog_pattern, bounced=True, click=lambda: pattern_setting_help(self.ui))
        self.ui.vpf_pushButton_01 = self.wc.setPushbutton('불러오기', parent=self.ui.dialog_pattern, bounced=True, click=lambda: volume_setting_load(self.ui))
        self.ui.vpf_pushButton_02 = self.wc.setPushbutton('저장하기', parent=self.ui.dialog_pattern, bounced=True, click=lambda: volume_setting_save(self.ui))
        ...
        self.ui.vlp_pushButton_02 = self.wc.setPushbutton('저장하기', parent=self.ui.dialog_pattern, bounced=True, click=lambda: volatility_setting_save(self.ui))
        ...
        self.ui.vst_pushButton_03 = self.wc.setPushbutton('학습하기', parent=self.ui.dialog_pattern, color=4, bounced=True, click=lambda: volatility_stop_take_train(self.ui))
