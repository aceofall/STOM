...
famous_saying = [
    ...
    '오늘 할 수 있는 일에 전력을 다하면 내일에는 한걸음 더 진보한다 / 뉴턴',
    '최대 다수의 최대 행복을 얻는 행동이 최선이다 / 허치슨',
    '햇빛은 하나의 초점에 모아질 때만 불꽃을 피우는 법이다 / 벨',
    '돈이 없는 것은 슬픈 일이지만 남아도는 것은 그 두 배나 슬픈 일이다 / 톨스토이',
    ...
    '남자는 언제나 여인의 첫사랑이 되고 싶고, 여자는 남자의 마지막 낭만이 되려고 한다.',
    ...
    '사랑하면서 바보가 되지 않는 사람은, 결코 사랑하면서 현명해질 수 없다 / 라이너 <사랑과 육욕>',
    ...
    '나는 죽음을 겁내지 않으며, 다만 의무를 다하지 않고 사는 것을 겁낸다 / 하운드',
    '만약 제군이 돈의 가치를 알고 싶으면 나가서 얼마간의 돈을 빌려 보라 / 프랭클린',
    '모든 날 중 가장 완전히 잃어버린 날은 웃지 않는 날이다 / 샹포르',
    '물고기를 한 끼 먹이려면 물고기 잡는 법을 가르쳐라, 그러면 평생을 먹을 것이다 / 탈무드',
    '할 수 있는 한 훌륭한 인생을 살아라. 인생은 짧고 곧 지나간다 / 오울디즈',
    ...
    '일이 재미있으면 인생은 낙원이고, 의무라면 인생은 지옥이다 / 고리키',
    ...
    '명성을 구하여 달리는 자는 명성에 따라갈 수 있으나, 명성에서 도망쳐 달리는 자는 명성에 붙잡힌다 / 탈무드',
    ...
    '선은 오직 하나 뿐이며, 그것은 자기 양심에 따라 행동하는 일이다 / 보봐르',
    ...
    '바다의 물이 마르면 나중에는 밑이 드러나지만, 그러나 사람은 죽어도 마음은 알지 못한다 / 명심보감',
    '인간은 죽음을 두려워하는 것은 생을 사랑하기 때문이다 / 도스토예프스키',
    '인생에 있어서 많은 고통을 면하는 최상의 방법은 자기의 이익을 아주 적게 생각하는 일이다 / 쥬베르',
    '한때의 분한 감정일랑 버리면, 그러면 백일의 근심을 모면할 것이다 / 경함록',
    ...
    '네가 가지고 있는 최선의 것을 세상에 내놓아라. 그러면 최선의 것이 돌아오리라 / 베레',
    '오늘을 붙들어라! 되도록 내일에 의지하지 말라! 그날 그날이 일년 중에서 최선의 날이다 / 에머슨',
    ...
    '가난은 많은 뿌리를 갖고 있으나, 큰 뿌리는 무식입니다 / 존슨',
    '일을 일에 쫓기지 말라 / 프랭클린',
    '할 수 있는 한 훌륭한 인생을 살아라. 인생은 짧고 곧 지나간다 / 오울디즈',
    ...
    '위대함에는 신비성이 필수적이다. 너무 알면 사람들은 존경하지 않는다 / 드골',
    '요구받기 전에 먼저 충고하지 말라 / 에라스무스',
    '커다란 비결은 결코 낡지 않은 인간으로서 인생을 끝까지 사는 것이다 / 슈바이처',
    ...
    '승자는 문제 속에 뛰어들고, 패자는 문제의 변두리에서만 맴돈다 / 빅토르 위고',
    ...
    '진리를 보기 원하는 자는 조각조각 떨어뜨려 보지 말고 전체를 보라 / 크리슈나무르티',
    ...
    '인내는 성공의 열쇠이며, 인내는 어떠한 괴로움에도 듣는 명약이다 / 플라토우스',
    ...
    '사랑은 그 종류가 하나 뿐이다. 그러나 사랑을 표현하는 방법은 수만 가지가 넘는다 / 그라시안',
    '꿈을 꾸는 사람은, 꿈이 없는 사람은 아무런 생명력도 없는 인형과 같다 / 그라시안',
    ...
    '빛을 퍼뜨릴 수 있는 방법은 두 가지이다. 촛불이 되거나 또는 그것을 비추는 거울이 되는 것이다 / 이디스 워튼',
    '이기는 것이 중요한 것이 아니라, 어떻게 노력하는가가 문제이다 / 쿠베르텐',
    ...
    '깊은 강물은 돌을 던져도 흐려지지 않는다. 모욕을 받고 이내 발칵하는 인간은 강도 아닌 조그마한 웅덩이에 불과하다 / 톨스토이',
    ...
    '시간이 모든 것을 말한다. 시간은 묻지 않았는데도 말을 해주는 수다쟁이다 / 에우리피데스',
    '확실한 일을 실행할 힘은 누구나 가지고 있다 / 괴테',
    '희망은 멀리 있는 것이 아니다. 바로 내 곁에, 나의 일상을 점검하자 / 릴케',
    '친절한 마음가짐의 원리, 타인에 대한 존경은 처세법의 제일 조건이다 / 아미엘',
    '공포로 인해 타협하지 말 것이며 남이 나에게 타협하는 것을 두려워하지도 말라 / 케네디',
    '오늘 할 수 있는 일에 전력을 다하면 내일에는 한걸음 더 진보한다 / 뉴턴',
    '만약 제군이 돈의 가치를 알고 싶으면 나가서 얼마간의 돈을 빌려 보라 / 프랭클린',
    '오늘이라는 날은 두 번 다시 오지 않는다는 것을 잊지 말라 / 단테',
    ...
    '미래를 신뢰하고, 죽은 과거를 묻어 버리고, 살아 있는 현재에 행동해라 / 롱펠로우',
    ...
    '행운은 자주 문을 두드리나 미련한 자는 그것을 받아들이지 않는다 / 덴마크속담',
    '오늘을 붙들어라! 되도록 내일에 의지하지 말라! 그날 그날이 일년 중에서 최선의 날이다 / 에머슨',
    '인간이 죽음을 두려워하는 것은 생을 사랑하기 때문이다 / 도스토예프스키',
    '추위에 떤 자일수록 태양의 따뜻함을 인생의 고뇌를 맛본 자일수록 생명의 존귀함을 느낀다 / 호이토 맨',
    '행운은 마음의 준비가 있는 사람에게만 미소를 짓는다 / 파스퇴르',
    '요구받기 전에 먼저 충고하지 말라 / 에라스무스',
    '커다란 비결은 결코 낡지 않은 인간으로서 인생을 끝까지 사는 것이다 / 슈바이처',
    ...
    '그대로 인하여 세계를 잃는 일이 있어도 세계를 위하여 그대를 잃고 싶지 않다 / 바이런',
    '돈은 거름과 같아서 뿌리지 않으면 썩기 쉽다 / 베이컨',
    '대문자만으로 인쇄된 책은 읽기 어렵다, 일요일 밖에 없는 인생도 그것과 마찬가지이다 / 장 파울',
    '칭찬받기를 원하면 자화자찬을 하지 말라 / 파스칼',
    '겨울이 오면 봄이 멀지 않으리 / 셸리',
    '지식이 비즈니스다 / 피터 드락커',
    '나의 언어의 한계는 나의 세계의 한계를 의미한다 / 비트겐슈타인',
    '돈이 없는 것은 슬프지만 남아도는 것은 그 두 배나 슬픈 일이다 / 톨스토이',
    '일곱 번의 70배까지 용서하라 / 그리스도',
    '삶이 있는 한 희망은 있다 / 키케로',
    ...
    '피할수 없으면 즐겨라 / 로버트 엘리엇',
    '주식시장은 돈을 전송하는 도구가 아니라, 자본을 효율적으로 배분하는 시스템이다 / 워렌 버핏',
    '다른 사람이 탐욕스러울 때 두려워하고, 다른 사람이 두려워할 때 탐욕스러워져라 / 워렌 버핏',
    '투자의 첫 번째 규칙은 손실을 피하는 것이고, 두 번째 규칙은 첫 번째 규칙을 기억하는 것이다 / 워렌 버핏',
    '가치 투자는 가격이 가치보다 낮을 때 사는 것이다 / 벤저 그레이엄',
    '단순함이 투자의 최고의 전략이다 / 워렌 버핏',
    '다각화는 투자의 유일한 무료 점심이다 / 레이 달리오',
    '현금은 왕이지만, 인플레이션은 왕을 죽인다 / 레이 달리오',
    '투자의 성공은 자기 통제에 달려 있다 / 찰리 멍거',
    '지속적으로 학습하라, 그것이 투자의 핵심이다 / 찰리 멍거',
    '시장의 타이밍을 맞추려 하지 말고, 투자의 타이밍을 맞춰라 / 존 템플턴',
    '투자는 확실성을 추구하는 것이 아니라 확률을 추구하는 것이다 / 하워드 막스',
    '리스크를 이해하지 못하면 투자하지 말라 / 하워드 막스',
    '투자의 성공은 10%의 분석과 90%의 심리학에 달려 있다 / 벤저 그레이엄',
    '단기적으로 주식시장은 투표 기계이지만, 장기적으로는 저울이다 / 벤저 그레이엄',
    '투자자의 최대 적은 자기 자신이다 / 벤저 그레이엄',
    '투자는 미래를 예측하는 것이 아니라, 현재를 이해하는 것이다 / 하워드 막스',
    '위험을 감수하지 않고는 수익을 얻을 수 없다 / 피터 린치',
    '투자는 게임이 아니라 비즈니스이다 / 워렌 버핏',
    '투자는 인내심과 규율의 게임이다 / 필립 피셔',
    '투자의 성공은 자신의 실수로부터 배우는 능력에 달려 있다 / 조지 소로스',
    '자신이 아는 것에만 투자하라 / 짐 로저스',
    '투자는 복리의 힘을 이해하는 것이다 / 앨버트 아인슈타인',
    '투자는 위험을 관리하는 것이다 / 로버트 기요사키',
    '투자 비용을 줄이는 것이 수익을 높이는 가장 확실한 방법이다 / 존 보글',
    '투자는 시장의 변동성을 이용하는 것이 아니라, 시장의 성장을 이용하는 것이다 / 존 보글',
    '투자는 감정을 통제하는 것이다 / 데이비드 스웬슨',
    '투자는 시장의 비효율성을 찾아내는 것이다 / 데이비드 스웬슨',
    '투자는 리스크와 수익의 균형을 맞추는 것이다 / 해리 마코위츠',
    '투자는 심리적 편향을 이해하는 것이다 / 대니얼 카너먼'
]
