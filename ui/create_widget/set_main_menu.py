...
class SetMainMenu:
    ...
    def set(self):
        ...
        self.ui.bb_pushButton = self.wc.setPushbutton('S', color=6, click=lambda: chart_screenshot(self.ui),      shortcut='Alt+S', animated=True, tip='차트창 스샷 텔레그램 전송')
        self.ui.ds_pushButton = self.wc.setPushbutton('V', color=6, click=lambda: manual_save_and_exit(self.ui),  shortcut='Alt+V', animated=True, tip='데이터 저장 및 수동 종료')
        self.ui.od_pushButton = self.wc.setPushbutton('O', color=6, click=lambda: show_order(self.ui),            shortcut='Alt+O', animated=True, tip='수동주문창')
        self.ui.zz_pushButton = self.wc.setPushbutton('E', color=6, click=lambda: extend_window(self.ui),         shortcut='Alt+E', animated=True, tip='전략탭확장')
        ...
        self.ui.bb_pushButton.setGeometry(8, 390, 16, 15)
        self.ui.ds_pushButton.setGeometry(23, 390, 16, 15)
        self.ui.od_pushButton.setGeometry(8, 410, 16, 15)
        self.ui.zz_pushButton.setGeometry(23, 410, 16, 15)
