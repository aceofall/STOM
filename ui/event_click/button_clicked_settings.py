...
def setting_load_04(ui):
    ...
    ui.sj_strgy_ckBox_01.setChecked(True if df['잔고청산'][no] else False)
    ui.sj_strgy_ckBox_02.setChecked(True if df['프로세스종료'][no] else False)
    ui.sj_strgy_ckBox_03.setChecked(True if df['컴퓨터종료'][no] else False)
    ui.sj_strgy_ckBox_04.setChecked(True if df['투자금고정'][no] else False)
    ui.sj_strgy_ckBox_05.setChecked(True if df['손실중지'][no] else False)
    ui.sj_strgy_ckBox_06.setChecked(True if df['수익중지'][no] else False)
...
def setting_load_05(ui):
    ...
    no = int(ui.dict_set['거래소'][-2:])
    ui.sj_back_cheBox_01.setChecked(True if df['블랙리스트추가'][no] else False)
    ui.sj_back_cheBox_02.setChecked(True if df['백테일괄로딩'][no] else False)
    ui.sj_back_cheBox_03.setChecked(True if not df['백테일괄로딩'][no] else False)
    ui.sj_back_cheBox_04.setChecked(True if df['디비자동관리'][no] else False)
    ui.sj_back_cheBox_06.setChecked(True if df['백테스케쥴실행'][no] else False)
    ui.sj_back_cheBox_05.setChecked(True if df['자동학습'][no] else False)
    ui.sj_back_cheBox_07.setChecked(True if not df['백테날짜고정'][no] else False)
    ui.sj_back_cheBox_08.setChecked(True if df['백테날짜고정'][no] else False)
    ui.sj_back_cheBox_09.setChecked(True if df['백테주문관리적용'][no] else False)
    ui.sj_back_cheBox_10.setChecked(True if df['교차검증가중치'][no] else False)
    ui.sj_back_cheBox_11.setChecked(True if df['범위자동관리'][no] else False)
    ui.sj_back_cheBox_12.setChecked(True if df['백테매수시간기준'][no] else False)
    ui.sj_back_cheBox_13.setChecked(True if df['백테스트로그기록안함'][no] else False)
    ui.sj_back_cheBox_14.setChecked(True if df['그래프저장하지않기'][no] else False)
    ui.sj_back_cheBox_15.setChecked(True if df['그래프띄우지않기'][no] else False)
    ui.sj_back_cheBox_16.setChecked(True if df['시장미시구조분석'][no] else False)
    ui.sj_back_cheBox_17.setChecked(True if df['캔들분석'][no] else False)
    ui.sj_back_cheBox_18.setChecked(True if df['리스크분석'][no] else False)
    ui.sj_back_cheBox_19.setChecked(True if df['거래량분석'][no] else False)
    ui.sj_back_cheBox_20.setChecked(True if df['가격대분석'][no] else False)
    ui.sj_back_cheBox_21.setChecked(True if df['변동성분석'][no] else False)
    ui.sj_back_cheBox_22.setChecked(True if df['변손익분석'][no] else False)
...
def setting_load_06(ui):
    ...
    ui.sj_etc_checBox_01.setChecked(True if df['저해상도'][no] else False)
    ui.sj_etc_checBox_02.setChecked(True if df['스톰라이브'][no] else False)
    ui.sj_etc_checBox_03.setChecked(True if df['휴무프로세스종료'][no] else False)
    ui.sj_etc_checBox_04.setChecked(True if df['휴무컴퓨터종료'][no] else False)
...
def setting_order_load_01(ui):
    ...
    ui.ss_buyy_checkBox_02.setChecked(True if df['매수주문유형'][no] == '지정가' else False)
    ui.ss_buyy_checkBox_03.setChecked(True if df['매수주문유형'][no] == '최유리지정가' else False)
    ui.ss_buyy_checkBox_04.setChecked(True if df['매수주문유형'][no] == '지정가IOC' else False)
    ui.ss_buyy_checkBox_05.setChecked(True if df['매수주문유형'][no] == '최유리IOC' else False)
    ui.ss_buyy_checkBox_06.setChecked(True if df['매수주문유형'][no] == '지정가FOK' else False)
    ui.ss_buyy_checkBox_07.setChecked(True if df['매수주문유형'][no] == '최유리FOK' else False)
    ui.ss_buyy_lineEdit_01.setText(str(df['매수분할횟수'][no]))
    ui.ss_buyy_checkBox_11.setChecked(True if df['매수분할방법'][no] == 1 else False)
    ui.ss_buyy_checkBox_12.setChecked(True if df['매수분할방법'][no] == 2 else False)
    ui.ss_buyy_checkBox_13.setChecked(True if df['매수분할방법'][no] == 3 else False)
    ui.ss_buyy_checkBox_14.setChecked(True if df['매수분할시그널'][no] else False)
    ui.ss_buyy_checkBox_15.setChecked(True if df['매수분할하방'][no] else False)
    ui.ss_buyy_checkBox_16.setChecked(True if df['매수분할상방'][no] else False)
    ui.ss_buyy_lineEdit_02.setText(str(df['매수분할하방수익률'][no]))
    ui.ss_buyy_lineEdit_03.setText(str(df['매수분할상방수익률'][no]))
    ui.ss_buyy_checkBox_17.setChecked(True if df['매수분할고정수익률'][no] else False)
    ...
    ui.ss_buyy_checkBox_18.setChecked(True if df['매수취소관심이탈'][no] else False)
    ui.ss_buyy_checkBox_19.setChecked(True if df['매수취소매도시그널'][no] else False)
    ui.ss_buyy_checkBox_20.setChecked(True if df['매수취소시간'][no] else False)
    ui.ss_buyy_lineEdit_04.setText(str(df['매수취소시간초'][no]))
    ui.ss_buyy_checkBox_21.setChecked(True if df['매수금지블랙리스트'][no] else False)
    ui.ss_buyy_checkBox_23.setChecked(True if df['매수금지손절횟수'][no] else False)
    ui.ss_buyy_lineEdit_06.setText(str(df['매수금지손절횟수값'][no]))
    ui.ss_buyy_checkBox_24.setChecked(True if df['매수금지거래횟수'][no] else False)
    ui.ss_buyy_lineEdit_07.setText(str(df['매수금지거래횟수값'][no]))
    ui.ss_buyy_checkBox_25.setChecked(True if df['매수금지시간'][no] else False)
    ui.ss_buyy_lineEdit_08.setText(str(df['매수금지시작시간'][no]))
    ui.ss_buyy_lineEdit_09.setText(str(df['매수금지종료시간'][no]))
    ui.ss_buyy_checkBox_26.setChecked(True if df['매수금지간격'][no] else False)
    ui.ss_buyy_lineEdit_10.setText(str(df['매수금지간격초'][no]))
    ui.ss_buyy_checkBox_27.setChecked(True if df['매수금지손절간격'][no] else False)
...
def setting_order_load_02(ui):
    ...
    ui.ss_sell_checkBox_02.setChecked(True if df['매도주문유형'][no] == '지정가' else False)
    ui.ss_sell_checkBox_03.setChecked(True if df['매도주문유형'][no] == '최유리지정가' else False)
    ui.ss_sell_checkBox_04.setChecked(True if df['매도주문유형'][no] == '지정가IOC' else False)
    ui.ss_sell_checkBox_05.setChecked(True if df['매도주문유형'][no] == '최유리IOC' else False)
    ui.ss_sell_checkBox_06.setChecked(True if df['매도주문유형'][no] == '지정가FOK' else False)
    ui.ss_sell_checkBox_07.setChecked(True if df['매도주문유형'][no] == '최유리FOK' else False)
    ui.ss_sell_lineEdit_01.setText(str(df['매도분할횟수'][no]))
    ui.ss_sell_checkBox_11.setChecked(True if df['매도분할방법'][no] == 1 else False)
    ui.ss_sell_checkBox_12.setChecked(True if df['매도분할방법'][no] == 2 else False)
    ui.ss_sell_checkBox_13.setChecked(True if df['매도분할방법'][no] == 3 else False)
    ui.ss_sell_checkBox_14.setChecked(True if df['매도분할시그널'][no] else False)
    ui.ss_sell_checkBox_15.setChecked(True if df['매도분할하방'][no] else False)
    ui.ss_sell_checkBox_16.setChecked(True if df['매도분할상방'][no] else False)
    ...
    ui.ss_sell_checkBox_17.setChecked(True if df['매도취소관심진입'][no] else False)
    ui.ss_sell_checkBox_18.setChecked(True if df['매도취소매수시그널'][no] else False)
    ui.ss_sell_checkBox_19.setChecked(True if df['매도취소시간'][no] else False)
    ui.ss_sell_lineEdit_04.setText(str(df['매도취소시간초'][no]))
    ui.ss_sell_checkBox_20.setChecked(True if df['매도금지매수횟수'][no] else False)
    ui.ss_sell_lineEdit_05.setText(str(df['매도금지매수횟수값'][no]))
    ui.ss_sell_checkBox_22.setChecked(True if df['매도금지시간'][no] else False)
    ui.ss_sell_lineEdit_07.setText(str(df['매도금지시작시간'][no]))
    ui.ss_sell_lineEdit_08.setText(str(df['매도금지종료시간'][no]))
    ui.ss_sell_checkBox_23.setChecked(True if df['매도금지간격'][no] else False)
    ...
    ui.ss_sell_checkBox_24.setChecked(True if df['매도익절수익률청산'][no] else False)
    ui.ss_sell_lineEdit_11.setText(str(df['매도익절수익률'][no]))
    ui.ss_sell_checkBox_25.setChecked(True if df['매도익절수익금청산'][no] else False)
    ui.ss_sell_lineEdit_12.setText(str(df['매도익절수익금'][no]))
    ui.ss_sell_checkBox_26.setChecked(True if df['매도손절수익률청산'][no] else False)
    ui.ss_sell_lineEdit_13.setText(str(df['매도손절수익률'][no]))
    ui.ss_sell_checkBox_27.setChecked(True if df['매도손절수익금청산'][no] else False)
